...
\rhead{}
\lfoot{
\cfoot{\scriptsize  $author-meta$ $if(updated)$ | \emph{Updated:} \today$endif$}}
...
\moveleft.5\hoffset\centerline{ $if(github)$$if(fontawesome)$\faGithub \hspace{1 mm}$else$\emph{Github:}$endif$ \href{http://github.com/$github$}{\tt $github$} \hspace{1 mm} $endif$ $if(twitter)$$if(fontawesome)$\faTwitter \hspace{1 mm}$else$\emph{Twitter:}$endif$ \href{https:/twitter.com/$twitter$}{\tt $twitter$} \hspace{1 mm} $endif$ }
